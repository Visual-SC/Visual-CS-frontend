...
const Footer: React.FC = () => {
  return (
    <footer className="bg-light-blue max-tablet-large:mt-4  ">
      <ol className="flex justify-center text-p-18 items-center gap-8 py-4 list-none font-semibold max-cellphone:flex-col">
        <li>
      ...
      <section className="grid grid-cols-2 grid-rows-2 gap-6 justify-center items-center py-4 w-fit mx-auto text-p-18 font-semibold
       max-cellphone:grid-cols-1 max-cellphone:text-center">
        <p>Lunes a Sábado</p>
        <p>09:00 a.m. - 07:00 p.m.</p>
        <p>Domingo</p>
        <p>10:00 a.m. - 06:00 p.m.</p>
      </section>
      <h3 className="text-dark-green font-haviland text-center mt-9 text-5xl max-cellphone:text-4xl">Gracias por tu amor al buen café </h3>
      <section className="max-cellphone:flex flex-col">
